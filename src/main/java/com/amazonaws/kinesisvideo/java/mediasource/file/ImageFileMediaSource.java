...
public class ImageFileMediaSource implements MediaSource {
    ...
    private static final byte[] AVCC_EXTRA_DATA = {
            ...
            (byte) 0x1F, (byte) 0x20};
//    private static byte[] AVCC_EXTRA_DATA = new byte[1440];
...
//        String filename = String.format("C:\\Users\\Incredible\\Downloads\\amazon-kinesis-video-streams-producer-sdk-java-master\\priv_data");
//        System.out.println(filename);
//        try {
//            fis = new FileInputStream(filename);
//            fis.read(AVCC_EXTRA_DATA);
//        } catch (FileNotFoundException e) {
//            e.printStackTrace();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        System.out.println(AVCC_EXTRA_DATA[0]+" "+AVCC_EXTRA_DATA[1]+" "+AVCC_EXTRA_DATA[2]+" "+AVCC_EXTRA_DATA[3]);
